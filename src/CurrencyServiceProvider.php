...
class CurrencyServiceProvider extends ServiceProvider
{
    ...
    public function boot() {
        $this->publishes([
            ...
            // views
            __DIR__ . '/../resources/views/upload.blade.php' => resource_path('veiw/techsmart/currency/upload.blade.php'),
            __DIR__ . '/../resources/views/chart.blade.php' => resource_path('veiw/techsmart/currency/chart.blade.php'),
            // migrations
